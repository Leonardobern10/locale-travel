...
export default function LocaleWay(): ReactElement {
     ...
     return (
          <section
               id="section-locale-way"
               className="w-full h-full flex flex-col items-center justify-between gap-y-15 padding-v-content padding-v-mobile font-hunnin md:bg-linear-to-t md:from-0% md:from-esmerald/70 md:to-40% md:to-white-default">
               <div className="flex flex-col items-center justify-between h-fit">
                    ...
                    <Subtitle
                         white={false}
                         title={LocaleWayServiceData.description}
                    />
               </div>
               <div
