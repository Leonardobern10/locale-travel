...
export default function Banner({
  ...
  return (
    <div
      ref={bannerRef}
      className="p-6 md:padding-h-content w-full md:w-1/2 h-full md:h-4/7 flex flex-col items-center md:items-start justify-center md:justify-between gap-y-4 md:gap-y-8"
    >
