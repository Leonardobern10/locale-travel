...
export const ourValueData: Array<OurValueComponentProps> = [
     {
          ...
          text1: 'Locale Travel é uma empresa independente, de propriedade e operação australiana. Nossa equipe já gerenciou projetos envolvendo algumas das tarefas mais complexas de logística de viagens e transporte na Austrália. Como empresa, temos ampla experiência em todas as áreas de gestão de viagens.',
