...
export const readAboutData = {
     ...
     text1: 'Nossa plataforma integra diversas soluções tecnológicas avançadas para otimizar a gestão das suas viagens, garantindo eficiência, segurança e uma experiência personalizada. Trabalhamos para conectar você aos melhores serviços do mercado, facilitando desde reservas até o acompanhamento em tempo real de seus itinerários.',
     text2: 'Estamos comprometidos em oferecer inovação constante, adaptando nossas ferramentas às demandas do seu negócio e proporcionando total controle e transparência em cada etapa da viagem.',
